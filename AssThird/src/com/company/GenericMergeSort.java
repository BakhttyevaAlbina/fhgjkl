...
public class GenericMergeSort<T extends Comparable <? super T>> {
    private boolean debug;	//turn on/off the debug messages


    public GenericMergeSort(boolean i_debug) {
        debug = i_debug;
    }

    public static void main(String[] args) {

        GenericMergeSort<Integer> ml = new GenericMergeSort(false);
        ...
        GenericMergeSort<String> ml2 = new GenericMergeSort(false);
    ...
    //call the mergesort on param list
    ...
    //used by the mergesort to do merging
